                        ...
                        <td style="padding: 0 40px 30px 40px;">
                            ...
                            <div
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <span style="color: #856404; font-size: 14px; font-weight: 600;">🎯 Mã Giảm Giá Đã
                                        Áp Dụng:</span>
                                    <span
                                        style="color: #856404; font-weight: bold; font-size: 16px;">{{ $data['ma_giam_gia'] }}</span>
                                </div>
                                <div
                                    ...
                                    <span
                                        style="color: #e17055; font-weight: bold; font-size: 14px;">-{{ number_format($data['tien_giam_gia']) }}</span>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <span
                                        style="color: #ffd700; font-size: 24px; font-weight: bold;">{{ number_format($data['so_tien']) }}</span>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div style="width: 150px; height: 150px; background-color: #f8f9fa; border: 1px solid #dee2e6; display: flex; align-items: center; justify-content: center; font-size: 12px; color: #666666; text-align: center; line-height: 1.3;">
                                            ...
                                            <img style="width: 300px" src="{{ $data['link_qr_code'] }}" alt="">
